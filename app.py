...
<style>
    ...
    * {
    ...
    /* Sidebar styling using data-testid */
...
"""
st.markdown(tricolor_html, unsafe_allow_html=True)
...
"""
st.markdown(form_card_start, unsafe_allow_html=True)
...
"""
st.markdown(footer_html, unsafe_allow_html=True) 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>'
