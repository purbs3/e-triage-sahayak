...
# ---------- CSS (stored as a clean triple-quoted string) ----------
CSS = r'''
<style>
...
with st.sidebar:
    ...
    <div style="text-align: center;">
        <div style="font-size: 2.5rem; background: #FF9933; border-radius: 50%; width: 70px; height: 70px; display: inline-flex; align-items: center; justify-content: center; color: #0B2B4A; font-weight: 900; margin-bottom: 10px;">S</div>
        <div class="sidebar-ministry">MINISTRY OF HEALTH</div>
        <div class="sidebar-sub">Govt. of India</div>
        <div style="text-align: center;"><span class="sidebar-tag">Ayushman Bharat</span></div>
        <hr style="border-color: #1E4A6F; margin: 20px 0;">
        <div class="sidebar-menu">> DIGITAL HEALTH MISSION</div>
        <div class="sidebar-menu">> e-Triage Sahayak v2.0</div>
        <div class="sidebar-menu">> ASHA Worker Module</div>
        <div class="sidebar-footer">NIC-CERTIFIED SECURE</div>
    </div>
    ''', unsafe_allow_html=True)

# ---------- SVG Icon Helpers (using raw strings to avoid backslash issues) ----------
def icon_user():
    return r'''<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0B2B4A" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M5.3 20a8 8 0 0 1 13.4 0"/></svg>'''

def icon_fever():
    return r'''<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0B2B4A" stroke-width="2"><path d="M12 2v4M12 22v-4M4 12H2M6 12H4M20 12H18M22 12H20M19.07 4.93l-2.83 2.83M4.93 19.07l2.83-2.83M19.07 19.07l-2.83-2.83M4.93 4.93l2.83 2.83"/><circle cx="12" cy="12" r="3"/><path d="M14 12a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/></svg>'''
...
def icon_heart():
    return r'''<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0B2B4A" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>'''

def icon_pregnant():
    return r'''<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0B2B4A" stroke-width="2"><circle cx="12" cy="10" r="3"/><path d="M12 13v6M9 16h6"/><path d="M5 21a8 8 0 0 1 14 0"/></svg>'''

def icon_diabetes():
    return r'''<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0B2B4A" stroke-width="2"><path d="M12 2v4M12 22v-4M4 12H2M6 12H4M20 12H18M22 12H20M19.07 4.93l-2.83 2.83M4.93 19.07l2.83-2.83M19.07 19.07l-2.83-2.83M4.93 4.93l2.83 2.83"/><path d="M12 8v8"/><path d="M8 12h8"/></svg>'''

def icon_alert_red():
    return r'''<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#DC2626" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>'''

def icon_alert_yellow():
    return r'''<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2"><path d="M12 2 L2 20 L22 20 L12 2z"/><path d="M12 9v4M12 17h.01"/></svg>'''

def icon_alert_green():
    return r'''<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#22C55E" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9 12l2 2 4-4"/></svg>'''
...
<div class="main-header">
    <div class="header-left">
        <div>
            <div class="header-title">e-Triage Sahayak</div>
            <div class="header-sub">National Health Mission - AI-Assisted Referral Decision System</div>
        </div>
    </div>
    <div class="header-right">
        <span class="header-badge">SECURE - PRODUCTION</span>
    </div>
</div>
''', unsafe_allow_html=True)
...
<div class="form-card">
    ...
    <div class="form-desc">Enter the primary vitals and symptoms. The system will generate an evidence-based triage recommendation as per MoHFW guidelines.</div>
''', unsafe_allow_html=True)
